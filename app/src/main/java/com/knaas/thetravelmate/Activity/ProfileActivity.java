...
public class ProfileActivity  extends AppCompatActivity {
    ...
    private TextView profileNameTextView, profileBioTextView, profilePhonenoTextView;
    private FirebaseAuth firebaseAuth;
    private FirebaseDatabase firebaseDatabase;
    private ImageView profilePicImageView;
    private FirebaseStorage firebaseStorage;
    private TextView textViewemailname,textViewProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileBioTextView = findViewById(R.id.profile_surname_textView);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot dataSnapshot) {
                ...
                profileBioTextView.setText(userProfile.getUserSurname());
                ...
                textViewProfile.setText("Hello "+userProfile.getUserName()+" !");
            }
            @Override
    ...
    public void buttonClickedEditName(View view) {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                String bio = profileBioTextView.getText().toString();
                String phoneno =  profilePhonenoTextView.getText().toString();
                Userinformation userinformation = new Userinformation(name,bio, phoneno);
    ...
    public void buttonClickedEditPhoneNo(View view) {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                String name = profileNameTextView.getText().toString();
                String surname = profileBioTextView.getText().toString();
